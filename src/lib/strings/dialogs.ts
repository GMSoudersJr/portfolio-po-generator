...
export const greeting = "A 'Cryption Key 🔐' is Needed";
export const directionsHeading = "Directions:";
export const directions = [
	"To encrypt and decrypt data, you will need a 'Cryption Key 🔐'.",
	"If you need a New Cryption Key 🔐, click the button in step 1.",
	"This will download a New Cryption Key 🔐 using your browser.",
...
export const invalidKeyDirections = [
	...
	"Click 'Back to Payees' to proceed with this Cryption Key",
	"If you need a New Cryption Key 🔐, click the button in step 1.",
	"This will download a New Cryption Key 🔐 using your browser.",
	"Then import your key by choosing that file in step 2.",
